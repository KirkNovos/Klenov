...
CREATE TABLE `materials_short_k_import` (
  ...
  `Тип материала` text,
  `Количество в упаковке` int DEFAULT NULL,
  `Единица измерения` text,
  `Количество на складе` int DEFAULT NULL,
  `Минимальный возможный остаток` int DEFAULT NULL,
  `Стоимость` text,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `products_k_import1`
--

DROP TABLE IF EXISTS `products_k_import1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `products_k_import1` (
  `id` int NOT NULL AUTO_INCREMENT,
  `NaimenovanieProdukcii` text,
  `Articul` int DEFAULT NULL,
  `MinCostForAgent` text,
  `Image` text,
  `TypeProduction` text,
  `CountPeopleForProd` int DEFAULT NULL,
  `NumberTseh` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-08 10:02:08
